...
import spring.demo.model.repositery.EmployeeRepository;
...
@ApiOperation(value="/api/v1" , tags="Employee Profile")
public class EmployeeController {
	...
	@ApiOperation(value="Insert Employees" , response=Employee.class)
	...
	@ApiOperation(value="Delete Employees" , response=Employee.class)
